...
mask = cv2.imread("PpCounterMask.png")
...
while True:
    ...
    cvzone.putTextRect(img, f' Count PP Up: {len(totalCountUp)}', (50, 50))
    cvzone.putTextRect(img, f' Count PP Down: {len(totalCountDown)}', (50, 100))
